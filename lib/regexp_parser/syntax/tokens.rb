  ...
  module Token
    ...
    module CharacterProperty
      ...
      module Category
        ...
        Codepoint     = [:cp_any, :cp_control, :cp_format,
                         :cp_surrogate, :cp_private, :cp_unassigned]

        Age           = [:age_1_1, :age_2_0, :age_2_1, :age_3_0, :age_3_1,
                         :age_3_2, :age_4_0, :age_4_1, :age_5_0, :age_5_1,
                         :age_5_2, :age_6_0]

        Derived       = [:derived_math, :derived_alphabetic,
                         :derived_lowercase, :derived_uppercase,
                         :derived_id_start, :derived_id_continue,
                         :derived_xid_start, :derived_xid_continue,
                         :derived_default_ignorable_cp,
                         :derived_grapheme_base, :derived_grapheme_extend]
        ...
        All = Letter + Mark + Number + Punctuation + Symbol + Separator +
              Codepoint + Age + Derived + Script
      end

      All = Type + POSIX + Category::All
    end
  end
