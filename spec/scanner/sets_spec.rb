...
RSpec.describe('Set scanning') do
  ...
  include_examples 'scan', '[\\x20-\\x27]',         1, :escape, :hex,             '\x20',       1, 5
  include_examples 'scan', '[\\x20-\\x28]',         2, :set,    :range,           '-',          5, 6
  include_examples 'scan', '[\\x20-\\x29]',         3, :escape, :hex,             '\x29',       6, 10
  ...
  include_examples 'scan', '[a-w&&[^c-g]z]',        5, :set,    :open,            '[',          6, 7
  include_examples 'scan', '[a-w&&[^c-h]z]',        6, :set,    :negate,          '^',          7, 8
  include_examples 'scan', '[a-w&&[^c-i]z]',        8, :set,    :range,           '-',          9, 10
  include_examples 'scan', '[a-w&&[^c-j]z]',        10,:set,    :close,           ']',          11, 12
