...
RSpec.describe(Regexp::Scanner) do
  ...
  include_examples 'scan error', RS::InvalidGroupError, 'invalid group', '(?<>)'
  include_examples 'scan error', RS::InvalidGroupError, 'invalid group', '(?<>empty-name)'
  include_examples 'scan error', RS::InvalidGroupOptionError, 'invalid option', '(?foo)'
  include_examples 'scan error', RS::InvalidGroupOptionError, 'invalid option', '(?mix abc)'
  include_examples 'scan error', RS::InvalidGroupOptionError, 'invalid option', '(?mix^bc'
  include_examples 'scan error', RS::InvalidGroupOptionError, 'invalid option', '(?)'
  include_examples 'scan error', RS::InvalidGroupOptionError, 'invalid neg option', '(?-foo)'
  include_examples 'scan error', RS::InvalidGroupOptionError, 'invalid neg option', '(?-u)'
  include_examples 'scan error', RS::InvalidGroupOptionError, 'invalid neg option', '(?-mixu)'
