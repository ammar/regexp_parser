...
but RDoc doesn't support such things. Will revisit properly in a wiki... soon.
  ...
  - Grouped Expressions
    - Atomic: (?>abc)                             ** SCANNER
    - Back-references:
      - Named: \k<name>                           ** SCANNER
      - Nest Level: \k<name-1>                    ** SCANNER
      - Numbered: \k<1>                           ** SCANNER
      - Relative: \k<-2>                          ** SCANNER
  ...
  - Unicode Properties: 
    ...
    - Derived Properties: \p{Math}, \P{Lowercase} ** SCANNER
    - General Categories: \p{Lu}, \P{Cs}, etc.    ** SCANNER
    - Scripts: \p{Arabic}, \P{Hiragana}           ** SCANNER
    - Simple Properties: \p{Dash}, \p{Extender}   ** SCANNER
