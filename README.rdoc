...
- Quantifiers
  ...
  - Possessive: ** PARSER COMPLETE (not in Oniguruma?)


== Notes
=== Scanner
* Checking regex syntax by instantiating a Regexp object from the input before
  scanning is a very bad idea and was removed. Syntax error checking is now a
  requirement. (See syntax and value errors in oniguruma.h)
