...
* Lexes and parses several regular expression flavors
    ...
    # Probably mostly there, but there are no syntax specs in place yet.
      # .NET
      # ARE (Tcl)
      # GNU (BRE/ERE)
      # Java
...
but RDoc doesn't support such things. Will revisit properly in a wiki... soon.
  ...
  - String Escapes
    ...
    - Meta: \M-c, \M-\x23, \M-\C-C etc.. ** NEEDS REVIEW/TESTS
    - Octal: \012 ** SCANNER COMPLETE
    - Unicode: \uHHHH, \u{H+ H+} ** SCANNER COMPLETE
  - Unicode Properties: 
